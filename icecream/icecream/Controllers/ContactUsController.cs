...
namespace icecream.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public ContactUsController(IceCreamParlourDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Name,Email,Message,CreatedAt")] ContactU contactU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Name,Email,Message,CreatedAt")] ContactU contactU)
        {
